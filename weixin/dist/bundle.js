...
app.get('/', function (req, res) {
    if (res.statusCode === 200)
        res.send('welcome.This\'s just for json or xml.');
    else
        res.send('error.');
});
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(21).concat(__webpack_require__(32)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(33).concat(__webpack_require__(81)) },
